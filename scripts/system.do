...
add wave -noupdate -group dp_variables /system_tb/DUT/CPU/DP/CLK
add wave -noupdate -group dp_variables /system_tb/DUT/CPU/DP/nRST
add wave -noupdate -group dp_variables /system_tb/DUT/CPU/DP/SignExt_addr
add wave -noupdate -group dp_variables /system_tb/DUT/CPU/DP/ZeroExt_addr
add wave -noupdate -group dp_variables /system_tb/DUT/CPU/DP/Ext_addr
add wave -noupdate -group dp_variables /system_tb/DUT/CPU/DP/npc
add wave -noupdate -group dp_variables /system_tb/DUT/CPU/DP/shift_left_1
add wave -noupdate -group dp_variables /system_tb/DUT/CPU/DP/extended_address
add wave -noupdate -group dp_variables /system_tb/DUT/CPU/DP/rd
add wave -noupdate -group dp_variables /system_tb/DUT/CPU/DP/opinfetch
add wave -noupdate -group dp_variables /system_tb/DUT/CPU/DP/opindecode
add wave -noupdate -group dp_variables /system_tb/DUT/CPU/DP/opinexec
add wave -noupdate -group dp_variables /system_tb/DUT/CPU/DP/opinmem
add wave -noupdate -group dp_variables /system_tb/DUT/CPU/DP/opinwrback
add wave -noupdate -group dp_variables /system_tb/DUT/CPU/DP/aluopinfetch
add wave -noupdate -group dp_variables /system_tb/DUT/CPU/DP/aluopindecode
...
add wave -noupdate -group {control unit} /system_tb/DUT/CPU/DP/cuif/reg_rs
add wave -noupdate -group {control unit} /system_tb/DUT/CPU/DP/cuif/reg_rt
add wave -noupdate -group {control unit} /system_tb/DUT/CPU/DP/cuif/reg_rd
...
add wave -noupdate -group {control unit} /system_tb/DUT/CPU/DP/cuif/MemWr
...
add wave -noupdate -group {control unit} /system_tb/DUT/CPU/DP/cuif/jal_s
...
add wave -noupdate -group {control unit} /system_tb/DUT/CPU/DP/cuif/beq_s
add wave -noupdate -group {control unit} /system_tb/DUT/CPU/DP/cuif/bne_s
add wave -noupdate -group {control unit} /system_tb/DUT/CPU/DP/cuif/jump_s
add wave -noupdate -group {control unit} /system_tb/DUT/CPU/DP/cuif/jr_s
add wave -noupdate -group {control unit} /system_tb/DUT/CPU/DP/cuif/lui
add wave -noupdate -group {control unit} /system_tb/DUT/CPU/DP/cuif/imm_addr
add wave -noupdate -group {control unit} /system_tb/DUT/CPU/DP/cuif/j_addr
add wave -noupdate -group {control unit} /system_tb/DUT/CPU/DP/cuif/shift_amt
...
add wave -noupdate -expand -group pc /system_tb/DUT/CPU/DP/pcif/pc_next
...
update
WaveRestoreZoom {0 ps} {1412671 ps}
