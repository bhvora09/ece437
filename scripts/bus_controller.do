...
add wave -noupdate -expand -group CCIF -expand -group Dcache -color Cyan -radix hexadecimal -childformat {{{/bus_controller_tb/DUT/ccif/daddr[1]} -radix hexadecimal} {{/bus_controller_tb/DUT/ccif/daddr[0]} -radix hexadecimal}} -expand -subitemconfig {{/bus_controller_tb/DUT/ccif/daddr[1]} {-color Cyan -radix hexadecimal} {/bus_controller_tb/DUT/ccif/daddr[0]} {-color Cyan -radix hexadecimal}} /bus_controller_tb/DUT/ccif/daddr
add wave -noupdate -expand -group CCIF -divider {New Divider}
...
add wave -noupdate -expand -group CCIF -expand -group {Cache Control} -color {Medium Violet Red} -radix binary /bus_controller_tb/DUT/ccif/ccwrite
...
WaveRestoreCursors {{Cursor 1} {122032 ps} 0}
...
update
WaveRestoreZoom {0 ps} {286376 ps}
